...
- 가상환경 만드는법 (anaconda)
-   1. anaconda prompt에 conda create -n name python=versionNumber
-   2. conda activate name 하면 ㅇㅋ.
...
# list를 데이터 프레임에 넣으면 나중에 ML돌릴 때 오류가 날 수 있음. 그래서 array형태로 훈련테스트 를 나눠야 한다.